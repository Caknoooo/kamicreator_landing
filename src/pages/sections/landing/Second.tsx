    ...
    >
      ...
      <div className="flex flex-col cont-height justify-center gap-y-20 sm:gap-y-28 lmd:px-10 2xl:px-4 box-border">
        <div className="flex flex-wrap justify-center gap-y-6 gap-x-6 ">
          <div className="flex flex-col gap-y-10 lmd:w-[55%] px-4 box-border">
            <div className="flex flex-col gap-y-6">
              <h2 className="text-3xl font-bold text-gray-700 md:text-4xl lg:text-5xl">
                Kenapa ada kamikreator?
              </h2>
              <p className="lg:text-lg">
                Kamikreator akan mematahkan stigma orang, yaitu bekerja di bidang digital creator harus memiliki keahlian tersendiri, kamikreator yakin itu semua bisa muncul ketika kita mau mengembangkannya.
              </p>
            </div>
            ...
            <div className="bg-gray-200 p-4">
              <p>
                Interested in becoming part of our creators? Get in touch with our team at{" "}
                <a href="" className="text-emerald-800 underline">
                  kamicreatornih@gmail.com
                </a>
              </p>
            </div>
          </div>
          {/* image */}
          <div className="w-full mt-4 lmd:w-[22%] px-6 box-border">
            <div className="bg-[url('/pic/content.png')] h-[20rem] w-full bg-cover bg-center shadow-2xl lmd:h-3/4 lg:h-[90%] rounded-md relative">
